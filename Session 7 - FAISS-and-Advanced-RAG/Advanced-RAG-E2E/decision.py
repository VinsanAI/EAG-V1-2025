...
def generate_plan(
    ...
    """Generates a tool call or final answer using an LLM based on structured perception and memory."""
    ...
    prompt = f"""\n
You are a reasoning driven AI agent with access to tools. Your job is to resolve the users request step-by-step by reasoning through the problem, selecting a tool if needed, and continuing Until the FINAL_ANSWER is produced. {tool_context}
